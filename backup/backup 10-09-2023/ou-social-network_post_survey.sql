...
CREATE TABLE `post_survey` (
  ...
  `survey_status` enum('OPEN','CLOSED') DEFAULT (_utf8mb4'OPEN'),
  PRIMARY KEY (`id`),
...
INSERT INTO `post_survey` VALUES (22,'2023-09-07 13:55:00','Khảo sát tình hình môn Java',NULL),(36,'2023-09-07 15:10:08','Khảo sát wibu',NULL);
...
-- Dump completed on 2023-09-10 17:40:08
